...
class UbloxDataModuleNode(base_node.BaseNode):
    """Gathers GPS and IMU data from the Ublox data module and publishes (writes)
    this data for all to use.
    """
